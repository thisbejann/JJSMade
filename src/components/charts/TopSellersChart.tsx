...
export function TopSellersChart() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Top Sellers by Profit</CardTitle>
      </CardHeader>
      <CardContent>
        {data === undefined ? (
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={top10} layout="vertical">
              ...
              <YAxis type="category" dataKey="seller" stroke={CHART_COLORS.text} tick={{ fill: CHART_COLORS.text }} fontSize={11} tickLine={false} width={100} />
